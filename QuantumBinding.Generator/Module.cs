...
public class Module
{
    ...
    public Module(string libraryName)
    {
        ...
        _namespaceMapping = new List<NamespaceMapping>();
    ...
    private readonly List<NamespaceMapping> _namespaceMapping;
    ...
    public ReadOnlyCollection<NamespaceMapping> NamespaceMapping => _namespaceMapping.AsReadOnly();
    ...
    public void AddNamespaceMapping(string fileName, string subNamespace, string outputFilePath, bool replaceBaseNamespace = false)
    {
        ...
        _namespaceMapping.Add(@namespace);
    }

    public static Module Create(string libraryName, bool createDefaultParser = true)
    {
        var module = new Module(libraryName).WithDefaultParser();
        if (createDefaultParser)
        {
            module.WithDefaultParser();
        }
        return module;
    }
}